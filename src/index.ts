...
app.get('/', (c) => c.json({
  ...
  endpoints: [
    ...
    { method: 'GET', path: '/api/market-data', description: 'Live Polymarket + Crypto market data. Real-time prediction markets, prices, volume', price: '0.003 USDC' },
